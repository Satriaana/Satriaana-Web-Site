...
class Titleintroduction extends Component {
    render(){
        return(
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style={{borderRadius: '10px'}}><img class="card-img w-100 d-block" style={{background: 'url(public/arif-riyanto-vJP-wZ6hGBg-unsplash.png) center / cover no-repeat', height: '320px', borderRadius: '10px'}}/>
