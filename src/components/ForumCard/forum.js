        ...
        <div class="container" style={{paddingTop: '50px'}}>
            <div class="row">
                <div class="col-md-12" style={{marginBottom: '10px'}}>
                    <h1 id="title" style={{fontSize: '40px', fontFamily: 'Kumbh Sans', fontWeight: 'bold'}}>Forum<button class="btn btn-primary float-right" type="button">Lorem Ipsum</button></h1>
            ...
            <div class="row" style={{paddingBottom: '50px'}}>
                <div class="col-md-4">
                    <div class="card" style={{borderRadius: '10px', marginBottom: '30px'}}><img alt="" class="card-img w-100 d-block" src={forumImage} style={{objectFit:"cover",height: '320px', borderRadius: '10px'}}/>
                ...
                <div class="col-md-4">
                    <div class="card" style={{borderRadius: '10px', marginBottom: '30px'}}><img alt="" class="card-img w-100 d-block" src={forumImage} style={{objectFit:"cover",height: '320px', background: 'url(./nordwood-themes-bJjsKbToY34-unsplash.png) center / cover no-repeat', borderRadius: '10px'}}/>
                        <div class="card-img-overlay">
