    ...
    return (
        ...
        <div class="container" style={{paddingTop: '50px'}}>
            ...
            <div class="row" style={{paddingBottom: '50px'}}>
                <div class="col-md-4">
                    <div class="card" style={{borderRadius: '10px', marginBottom: '30px'}}><img class="card-img w-100 d-block" style={{height: '320px', borderRadius: '10px'}}/>
                ...
                <div class="col-md-4">
                    <div class="card" style={{borderRadius: '10px', marginBottom: '30px'}}><img class="card-img w-100 d-block" style={{height: '320px', background: 'url(./nordwood-themes-bJjsKbToY34-unsplash.png) center / cover no-repeat', borderRadius: '10px'}}/>
