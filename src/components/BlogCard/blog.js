        ...
        <div className="container" style={{paddingTop: '50px'}}>
            <div className="row">
                <div className="col-md-12" style={{marginBottom: '15px'}}>
                    <h1 id="title" style={{color: 'rgb(255,255,255)', fontSize: '40px', fontFamily: 'Kumbh Sans', fontWeight: 'bold'}}>Blog<button class="btn btn-primary float-right" type="button" style={{backgroundColor: 'rgb(248,248,248)', fontFamily: 'Kumbh Sans'}}>Lorem Ipsum</button></h1>
            ...
            <div className="row">
                <div className="col-md-6" style={{marginBottom: '30px'}}>
                    <div className="card" style={{borderRadius: '10px'}}><img alt="" class="card-img-top w-100 d-block" src={article1ImgSrc} style={{objectFit:"cover",background: 'url(./john-schnobrich-FlPc9_VocJ4-unsplash.png) center / cover no-repeat', height: '402.5px', borderRadius: '10px'}}/>
                ...
                <div className="col-md-6">
                    <div className="row" style={{marginBottom: '20px'}}>
                        <div className="col">
                            <div className="card" style={{borderRadius: '10px'}}><img alt="" class="card-img-top w-100 d-block" src={article2ImgSrc} style={{objectFit:"cover",background: 'url(./nordwood-themes-bJjsKbToY34-unsplash.png) center / cover no-repeat', height: '145px', borderRadius: '10px'}}/>
                    ...
                    <div className="row">
                        <div className="col" style={{marginTop: '10px'}}>
                            <div className="card" style={{borderRadius: '10px'}}><img alt="" class="card-img-top w-100 d-block" src={article4ImgSrc} style={{objectFit:"cover",background: 'url(./arif-riyanto-vJP-wZ6hGBg-unsplash.png) center / cover no-repeat', height: '150px', borderRadius: '10px'}}/>
